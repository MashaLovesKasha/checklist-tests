describe('Edits tasks',{ tags: ['medium-priority'] }, () => {
    ...
    it('Edits an active task, replacing the text', () => {
        ...
        cy.log(`Edits an active task and replaces its text with "${updatedText}". The task remains active`)
    ...
    it('Edits a completed task, appending new text', () => {
        ...
        cy.log(`Completes a task and appends "${appendedText}" to its text. The task remains completed`)
